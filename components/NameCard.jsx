    ...
    return (
        <div >
            <SplitText
                ...
                className="font-black text-gray-900 md:text-4xl lg:text-5xl text-2xl text-wrap"
                delay={30}
                duration={0.3}
                ease="power3.out"
                splitType="chars"
            ...
            />
            <div>
                <p className="font-medium text-gray-800 lg:text-3xl text-lg">A Full-stack developer</p>
